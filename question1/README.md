...
The system is structured using classes such as:

Order

Churros

Objects of these classes are created to represent real-world entities.
...
The queue ensures that orders are delivered in the same order they were placed:
